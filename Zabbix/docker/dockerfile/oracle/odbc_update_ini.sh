#!/bin/sh
#
# $Header: odbc/utl/odbc_update_ini.sh /main/21 2015/09/07 23:37:38 akumarb Exp $
#
# odbc_update_ini.sh
#
...
#
DRIVER_DESCRIPTION="Oracle ODBC driver for Oracle 12c"
...
if [ ! "$3" ]
     then
        DRIVER_NAME="Oracle 12c ODBC driver"
     else
        DRIVER_NAME="$3"
fi
